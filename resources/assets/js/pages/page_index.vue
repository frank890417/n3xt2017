  ...
  section.sectionPhoto.red
    .container-fluid
      ...
      slideIn.row.rowPhoto
        .col-sm-8
          a.img.big(:style="{'background-image': `url(/img/sitephoto/Pic01.jpg)`}", href="https://goo.gl/photos/QQxauWqGwsoWSQEEA" , target="_blank")
        .col-sm-4
  ...
  //section.sectionPartner.white.text-center
    .container
      .row
        ...
        .col-sm-12
          img.logo(src="https://d3n8a8pro7vhmx.cloudfront.net/ccla/pages/160/attachments/original/1492556073/CClogo_HiRes_%281%29.png?1492556073")
