        ...
        .col-sm-8
          ul.timeline
            ...
            li(v-for="i in 4")
              .time 06:00-06:30
              .content
                p Check In & Pre Networking Industry-trending brands <br>Industry-trending brands that
          ul.timeline
            .datetag Sep.8
            li(v-for="i in 2")
              .time 06:00-06:30
  ...
  section.sectionGuest.white
    .container
      .row
        ...
        .col-sm-12
          ul.row.speakers
            li.col-sm-4(v-for="i in 4")
              .headshot(style="background-image: url(https://i.vimeocdn.com/portrait/6198925_300x300)")
              h4.place ​HBO, ​Vice President of Production
              h3.name NATASHA FOSTER-OWENS
  ...
  section.sectionOranizers.white
    .container
      .row
        ...
        .col-sm-7
          ul.agencies
            li(v-for="i in 3") VGSA
  section.sectionOranizers.grey
    .container
      .row
        .col-sm-5
          h2 Registration
